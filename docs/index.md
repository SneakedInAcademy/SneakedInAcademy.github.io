# Sneaked In Academy Guides

Willkommen zu einer Sammlung von Guides und Ressourcen für **EVE Online**.  
Diese Seite soll neuen und erfahrenen Spielern helfen, sich schneller in den wichtigsten Bereichen des Spiels zurechtzufinden.

---

## Industry

Alles rund um Ressourcen und Produktion.
...
- [Faction Warfare Basics](faction-warfare/fw-basics.md)

---

## Tools & Resources

Nützliche Webseiten und Hilfsmittel.

- [Maps](links/maps.md)
- [Market Tools](links/market.md)
- [Fitting Tools](links/fitting-tools.md)
- [Killboards](links/killboards.md)
- [Forums](links/forums.md)
- [Discord Communities](links/discord.md)
- [Resources](links/resources.md)
- [Calculators](links/calculators.md)